...
class Parser:
    ...
    def __init__(self, user_query: str):
        ...
        self.regex_words = r'([Тт]аблетки| [Рр]аствор| [Пп]орошок| [Сс]прей| [Сс]редство| [Кк]апли| [Кк]апсулы| ' \
                           r'[Кк]рем| [Гг]ель| [Кк]рем-| [Мм]армелад| [Кк]онцентрат| [Кк]апм| [Пп]астилки| капс.|  капс|' \
                           r'[Тт]абл.| [Гг]ранулы| [Сс]успензия| [Сс]уппозитории| таб| р-р| пор| [Гг]ран| [Сс]ироп|' \
                           r'спрей | [Сс]редство| [Сс]упп| [Кк]апс| [Кк]апс.| [Сс]вечи| [Пп]рокладки| [Пп]одгузники|' \
                           r' [Пп]омада| [Мм]асло| [Шш]ампунь| [Мм]аска| [Лл]ак)'
        self.headers = {

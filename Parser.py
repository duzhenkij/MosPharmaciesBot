...
class Parser:
    ...
    def __init__(self, user_query: str):
        ...
        self.regex_words = r'([Тт]аблетки| [Рр]аствор| [Пп]орошок| [Сс]прей| [Сс]редство| [Кк]апли| [Кк]апсулы| ' \
                           r'[Кк]рем| [Гг]ель| [Кк]рем-| [Мм]армелад| [Кк]онцентрат| [Кк]апм| [Пп]астилки| ' \
                           r'[Тт]абл.| [Гг]ранулы| [Сс]успензия| [Сс]уппозитории| таб| р-р| пор| ' \
                           r'спрей | [Сс]редство| капли| [Сс]упп)'
        self.headers = {

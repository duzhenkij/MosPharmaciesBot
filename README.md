...
Bot has a simple working principle: a user sends a request with the name of a medicine and bot returns a list of such medicines from different pharmacies sorted by price ascending (max 20 lines).
...
The bot is located here (<b>@MosPharmaciesBot</b>)
